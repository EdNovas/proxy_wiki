...
date: 2026-05-10
description: 对比 DNS over HTTPS (DoH)、DNS over TLS (DoT)、DNS over QUIC (DoQ) 三种加密 DNS 协议的原理、优劣及在中国代理场景中的最佳选择方案。
keywords: DoH, DoT, DoQ, DNS over HTTPS, DNS over TLS, DNS over QUIC, 加密DNS, DNS加密, DNS污染, DNS隐私, 科学上网DNS, Clash DNS, 代理DNS, 国内DoH, 阿里DoH, 腾讯DoH
---
...
> 本文更新于 2026-05-10 | [ednovas.xyz](https://ednovas.xyz)
