...
> **最后更新**: 2026-05-10 | **适用平台**: Windows / macOS / Linux / Android / iOS
...
- 使用 [speedtest.net](https://www.speedtest.net/)，选择与你代理节点同地区的测速服务器
- 例如用香港节点，就选香港的测速服务器
...
1. 使用 VLESS + Reality 配合 `flow: xtls-rprx-vision` —— 这个组合通过复用底层 TLS 连接的方式减少了额外的加密开销
...
3. **使用客户端内置测速**：部分代理客户端有内置测速功能，可以快速对比不同节点
   - Clash Verge：代理页面的测速按钮，可以批量测试所有节点的延迟
   - v2rayN：右键节点 → 测试真连接延迟
...
*本文由 [ednovas.xyz](https://ednovas.xyz) 提供，仅供学习参考。*
