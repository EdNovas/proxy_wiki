...
> **最后更新**: 2026-05-10 | **适用平台**: Windows / macOS / Linux
...
TUN 模式通过 `dns-hijack` 参数劫持系统发出的 DNS 请求（通常是发往 UDP 53 端口的查询），由代理客户端统一处理 DNS 解析。这既能防止 DNS 泄漏，又能让 Fake-IP 等高级 DNS 策略生效。
