...
tags:
  ...
  - Tor
  - 新手入门
index_img: /images/posts/privacy-boundaries.jpg
excerpt: 代理能帮你访问被封锁的网站，但不是隐私的万能盾牌。本文明确代理在安全和隐私方面的能力边界。
---
...
**如果你需要真正的匿名性**，应该考虑 [Tor 网络](https://www.torproject.org/)。Tor 通过三层中继节点传递流量，没有任何单一节点能同时知道你的身份和你的目标。但 Tor 的代价是速度极慢（通常只有几百 Kbps 到几 Mbps），而且使用体验很差。对绝大多数人来说，Tor 解决的是不同层级的问题——它适合记者、活动人士等有极端匿名需求的人，不适合日常使用。

![安全与隐私保护](/images/inline/lock-security.jpg)
...
![全球网络与数据传输](/images/inline/globe-network.jpg)
*图片来源：[Unsplash](https://unsplash.com/)*
...
7. **如果你需要真正的匿名：使用 [Tor](https://www.torproject.org/)，而不是普通的代理服务。** Tor 的设计目标就是匿名性，它为此牺牲了速度和便利性。普通代理的设计目标是绕过封锁和提供基本隐私，两者不是一回事。
