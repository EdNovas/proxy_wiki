...
tags:
  ...
  - 机场
  - 套餐
excerpt: "看懂机场套餐参数——倍率、流量、限速、在线设备数各自的含义和选择要点。"
index_img: /images/posts/airport-parameters.jpg
---
...
**ISP 带宽是天花板**。你的本地宽带速度是一切的前提。如果你的家庭宽带是 100Mbps，那么花钱买 500Mbps 限速的代理套餐就是浪费——你的速度永远不会超过 100Mbps。购买代理套餐前，先用 [Speedtest](https://www.speedtest.net/) 测一下你的裸连速度。
...
**基本计算方式**：每个运行代理客户端并连接到节点的设备算一台。你的手机开着 Shadowrocket 连接代理、笔记本开着 [Clash Verge Rev](https://github.com/clash-verge-rev/clash-verge-rev) 连接代理、台式机开着 v2rayN 连接代理——这就是 3 台设备。
...
**路由器方案：突破设备限制的最佳方式**。如果你把代理配置在路由器上（通过 OpenWrt + [OpenClash](https://github.com/vernesong/OpenClash)/[PassWall](https://github.com/Openwrt-Passwall/openwrt-passwall2) 等方案），所有通过这个路由器上网的设备都走代理，但机场只会看到一台设备（路由器本身）。这是在设备限制较低时服务多台设备的最有效方案。一台路由器可以覆盖全家所有设备。
