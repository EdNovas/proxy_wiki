...
index_img: /images/posts/vmess-to-vless-evolution.jpg
---
...
RPRX 从 v2ray-core fork 出了 Xray-core，并以此为基础独立发展。Xray 成为 VLESS 和 XTLS 的主要载体，并逐渐在功能和性能上超越了原版 V2Ray。
...
uTLS 库的出现是对这一检测手段的直接回应。Xray-core 和后来的 sing-box 都集成了 uTLS，用户只需要配置 `fingerprint: chrome` 就能模拟 Chrome 的 TLS 指纹。
...
**第二梯队：Hysteria2（UDP 场景补充）** —— 在 UDP 友好的网络环境中性能极为出色。推荐与 VLESS+Reality 同时部署。
