...
tags:
  ...
  - 客户端
  - 软件推荐
index_img: /images/posts/software-overview.webp
...
![Clash Verge Rev 界面](/images/inline/clash-verge-ui.webp)
...
| 客户端 | 内核 | 特点 | 推荐度 |
|--------|------|------|--------|
| [Clash Meta for Android](https://github.com/MetaCubeX/ClashMetaForAndroid) | mihomo | Clash 生态，规则分流强大 | ⭐⭐⭐⭐⭐ |
| [v2rayNG](https://github.com/2dust/v2rayNG) | xray-core | 轻量稳定，支持最新协议 | ⭐⭐⭐⭐ |
| [NekoBox](https://github.com/MatsuriDayo/NekoBoxForAndroid) | sing-box | sing-box 生态，功能丰富 | ⭐⭐⭐ |
| [Surfboard](https://github.com/getsurfboard/surfboard/releases) | 自研内核 | 兼容 Surge 规则格式 | ⭐⭐⭐ |
