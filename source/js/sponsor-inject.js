document.addEventListener('DOMContentLoaded', function () {
  ...
  if (postContent) {
    var sponsorHTML = ''
      ...
      + '    <a href="https://ednovas.me" target="_blank" rel="noopener" class="sponsor-card-btn sponsor-card-btn-primary" style="background:linear-gradient(135deg,#3b82f6,#2563eb)"><i class="fa-solid fa-bolt"></i><span>官网地址</span></a>'
      ...
      + '    <a href="https://t.me/ednovasyun" target="_blank" rel="noopener" class="sponsor-card-btn sponsor-card-btn-secondary"><i class="fa-brands fa-telegram"></i><span>TG 群组</span></a>'
      + '  </div>'
      + '</div>'
      // TransLink
      ...
      + '  </div>'
      + '  <div class="sponsor-card-buttons">'
      + '    <a href="https://translink.cc" target="_blank" rel="noopener" class="sponsor-card-btn sponsor-card-btn-primary"><i class="fa-solid fa-shield-halved"></i><span>官网地址</span></a>'
      + '    <a href="https://t.me/translink_cloud" target="_blank" rel="noopener" class="sponsor-card-btn sponsor-card-btn-secondary"><i class="fa-brands fa-telegram"></i><span>TG 群组</span></a>'
      + '  </div>'
      + '</div>'
      // 底部链接
