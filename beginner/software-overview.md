# V2Ray、Xray、Clash、Sing-box……我该用哪个？
...
- **sing-box** —— 全新架构，从零开发
- **mihomo**（Clash Meta 内核）—— Clash 生态的核心
...
| 客户端 | 内核 | 特点 | 推荐度 |
|--------|------|------|--------|
| Clash Verge Rev | mihomo | 规则分流强大，GUI 美观，跨平台一致体验 | ⭐⭐⭐⭐⭐ |
| v2rayN | xray-core / sing-box | 功能全面，支持切换内核，协议支持最广 | ⭐⭐⭐⭐ |
...
| 方案 | 内核 | 特点 | 推荐度 |
|------|------|------|--------|
| OpenClash | mihomo | 最成熟的路由器方案，Web UI 完善 | ⭐⭐⭐⭐⭐ |
